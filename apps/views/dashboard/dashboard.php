<div>
    <div id="page-head">
        ...
        <div class="pad-all text-center">
            ...
            <p1>Scroll down to see quick links and overviews of your Server, To do list, Order status or get some Help
                using Nifty.</p>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <div class="panel panel-success panel-colorful">
                            <div class="pad-all">
                                <p class="text-lg text-semibold"><i class="demo-pli-data-storage icon-fw"></i> HDD Usage
                                </p>
                                <p class="mar-no">
                        ...
                        <div class="col-sm-8">
                            ...
                            <ul class="list-unstyled text-center bord-top pad-top mar-no row">
                                <li class="col-xs-4">
                                    ...
                                    <p class="text-sm text-muted mar-no">Normal</p>
                                </li>
                                <li class="col-xs-4">
                                    <span class="text-lg text-semibold text-main">23K</span>
                                    <p class="text-sm text-muted mar-no">Kurus</p>
                                </li>
                                <li class="col-xs-4">
                                    <span class="text-lg text-semibold text-main">278</span>
                                    <p class="text-sm text-muted mar-no">Obesitas</p>
                                </li>
                            </ul>
                        </div>
                    </div>
