...
<div>
    <div id="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow">Pengujian Data</h1>
        </div>
        <ol class="breadcrumb">
    ...
    <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Pengujian Data</h3>
            </div>
            <div class="panel-body">
                <form id="cekf" name="cekf" class="form-inline">
                    ...
                    <button id="btn-uji-data" class="btn btn-primary" type="button">Uji Data</button>
                    <button id="btn-download-template" class="btn btn-primary" type="button">Download Template</button>
                </form>
            </div>
        </div>
        <div id="panel-confusion" style="display: none;"">
            <div class="panel" id="panel-hasil">
                <div class="panel-heading">
                    <h3 class="panel-title">Hasil Uji Data</h3>
                </div>
                <div class="panel-body">
