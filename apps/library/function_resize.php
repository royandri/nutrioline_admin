...
function ResizeImage_150($newname150){
...
if ($foo->uploaded) {
   ...
   $foo->file_new_name_body = $newname150; ////.DATE("His")
...
function ResizeImage_350($newname350){
 $foo = new Upload($_FILES['image']); 
if ($foo->uploaded) {
   // save uploaded image with no changes
   ...
   // resized to 100px wide
   $filename=$_FILES['image'];
   $foo->file_new_name_body = $newname350; ////.DATE("His")
   $foo->image_resize = true;
   $foo->image_convert = 'jpg';
   $foo->image_x = 350;
   $foo->image_ratio_y = true;
...
function ResizeImage_750($newname750){
 $foo = new Upload($_FILES['image']); 
if ($foo->uploaded) {
   // save uploaded image with no changes
   ...
   // resized to 100px wide
   $filename=$_FILES['image'];
   $foo->file_new_name_body = $newname750; ////.DATE("His")
   $foo->image_resize = true;
   $foo->image_convert = 'jpg';
   $foo->image_x = 750;
   $foo->image_ratio_y = true;
...
/*
function ResizeImage_Gallery($gallery750, $i, $prename_name){
...
$files = array();
   ...
   foreach ($files as $file) {
       ...
       $foo->file_new_name_body = $gallery750; ////.DATE("His")
       $foo->image_resize = true;
       $foo->image_convert = 'jpg';
       $foo->image_x = 750;
       $foo->image_ratio_y = true;
       $path=path_foto().'room/gallery/';
       $foo->Process($path);
       $result='resize success';
       return $result;
        }
 ...
 */
   ...
   //hotel
   function Hotel_ResizeImage_150($newname150){
 $foo = new Upload($_FILES['image']); 
if ($foo->uploaded) {
   // save uploaded image with no changes
...
function Hotel_ResizeImage_350($newname350){
 $foo = new Upload($_FILES['image']); 
if ($foo->uploaded) {
   // save uploaded image with no changes
...
function Hotel_ResizeImage_750($newname750){
 $foo = new Upload($_FILES['image']); 
if ($foo->uploaded) {
   // save uploaded image with no changes
